...
const Summary: FC<IProps> = ({navigation}) => {
  ...
  return (
    <>
      <SafeAreaView style={styles.nav_card} edges={['top', 'left', 'right']}>
      ...
      <ScrollView
        ...
        <View style={styles.orders_container}>
          ...
          <View style={styles.description_container}>
            <Text style={[styles.bold_txt, {color: colors.GRAY}]}>Max Gas</Text>
            ...
            <View style={styles.amount_container}>
              ...
              <Text style={[styles.bold_txt, {color: colors.GRAY}]}>₦6800</Text>
            </View>
          </View>
        </View>
